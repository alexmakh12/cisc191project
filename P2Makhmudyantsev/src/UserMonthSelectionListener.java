 ...
 *         - Creates a user month selection listener that implements
 *         ActionListener to perform actions when a user selects an month in
 *         the userMonthSelection JComboBox
 * 
 */
/**
 */
...
public class UserMonthSelectionListener implements ItemListener
{
	...
	/**
	 * Constructor that creates a new UserMonthSelectionListener object
	 * 
	 * @param userMonthSelection
